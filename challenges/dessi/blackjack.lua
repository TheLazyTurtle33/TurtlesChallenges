...
--         -- Adjust Aces from 11 -> 1 if necessary
--         while sum > 21 and aces > 0 do
--             sum = sum - 10
--             aces = aces - 1
--         end

--         -- Check for blackjack (Ace + 10-value card, exactly 2 cards)
--         local is_blackjack = false
--         if #cards == 2 then
...
--         -- Check for 777 (exactly three 7s)
--         local is_777 = false
--         if #cards == 3 then
